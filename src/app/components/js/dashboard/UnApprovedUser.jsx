...
const headCells = [
  ...
  { id: 'visiting.name', numeric: false, disablePadding: false, label: 'Contact Person' },
  { id: 'visiting.purpose', numeric: false, disablePadding: false, label: 'Purpose of Visit' },
];
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell>{row.visiting.name}</TableCell>
                      <TableCell>{row.visiting.purpose}</TableCell>
                    </TableRow>
                  );
                })}
